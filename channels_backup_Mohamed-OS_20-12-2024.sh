...
wget -O /var/volatile/tmp/$channel-$"version".tar.gz "https://raw.githubusercontent.com/Ham-ahmed/11863/refs/heads/main/channels_backup_moh-os_2024_12_20.tar.gz"
